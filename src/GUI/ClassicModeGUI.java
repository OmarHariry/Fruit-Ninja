...
public class ClassicModeGUI {
	...
	public void prepareScene() {
		...
		VBox vb = new VBox(scoreLabel,lives, comboLabel);
...
//					track3.getMediaPlayer().setMute(true);
				...
				else if(obj.get(i) instanceof Special) {
				...
				if(bestCombo>=controller.getCombo())
...
//							+ "\nYour Missed Are " + controller.getMissed()
							+ "\nYour Highest Combo Is " + controller.getCombo());
					alert.show();
					alert.setOnHidden(e -> {
						stage.close();
					});
